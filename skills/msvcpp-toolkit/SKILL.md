...
Consumed by test-practice's **Concurrent correctness** section and the VERIFY stages of algo-rewrite/algo-craft/perf-tune. Enforcement for correctness of concurrent code, distinct from the Concurrency section's *facilities*:
